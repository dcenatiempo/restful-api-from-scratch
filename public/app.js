  ...
  if(formId == 'accountCreate'){
    ...
    app.client.request(undefined,'api/tokens','POST',undefined,newPayload,function(newStatusCode,newResponsePayload){
      ...
      if(newStatusCode !== 200){
        ...
        // Set the form-error field with the error text
        document.querySelector("#"+formId+" .form-error").innerHTML = 'Sorry, an error has occured. Please try again.';
      ...
      if(statusCode == 200){
        ...
        if(allChecks.length > 0){
          ...
          allChecks.forEach(function(checkId){
            ...
            app.client.request(undefined,'api/checks','GET',newQueryStringObject,undefined,function(statusCode,responsePayload){
              if(statusCode == 200){
                ...
                var table = document.getElementById("checks-list-table");
          ...
          if(allChecks.length < 5){
            ...
            document.getElementById("create-check-cta").style.display = 'block';
          }
